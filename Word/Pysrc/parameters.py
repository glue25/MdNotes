...
class Phase() :
    ...
    _Phases['LegalMDInputPhase'] = _Phases['LegalMDInputPhase'] + [x.lower() for x in _Phases['LegalMDInputPhase']]
    ...
    _Phases['LegalMDOutputPhase'] = _Phases['LegalMDOutputPhase'] + [x.lower() for x in _Phases['LegalMDOutputPhase']]
